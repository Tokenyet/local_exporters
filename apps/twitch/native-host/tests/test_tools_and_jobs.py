...
from twitch_local_exporter.config import (
    product_tools_dir,
    toolchain_mode,
    toolchain_root,
    tools_dir,
...
from twitch_local_exporter.tools import (
...
class ToolsAndJobsTests(unittest.TestCase):
    ...
    def test_macos_tool_names_are_resolved_from_unix_bundles(self):
        ...
        try:
            with tempfile.TemporaryDirectory() as tmp:
                ...
                with patch("twitch_local_exporter.tools.sys.platform", "darwin"):
    ...
    def test_update_script_uses_shell_on_macos(self):
        with patch("twitch_local_exporter.config.sys.platform", "darwin"):
