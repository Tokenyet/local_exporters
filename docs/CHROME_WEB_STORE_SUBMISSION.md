...
- **Single purpose:** Export user-authorized media from the active Twitch or YouTube page to local files through a local native host on Windows or macOS.
...
- `nativeMessaging`: Send the explicit export request to the local native host.
