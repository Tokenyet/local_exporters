...
These are draft copy for the two independently packaged extensions. The extensions are not one combined product in the browser.

## Twitch Local Exporter

### Short description

Export authorized Twitch VOD video, audio, subtitles, and chat to local files.
...
The extension reads the active Twitch page when you use the popup. Preferences are stored in browser sync storage. It does not provide cloud transcription or upload generated media to a developer service.

Use it only for VODs you own or are authorized to export.
...
Export authorized YouTube video, audio, and subtitles to local files.
...
The extension reads the active YouTube page when you use the popup. Preferences are stored in browser sync storage. It does not provide cloud transcription or upload generated media to a developer service.

Use it only for videos you own or are authorized to export.
